...
export const ActionSheet = forwardRef<BottomSheet, ActionSheetProps>(
  ({ title, subtitle, actions, isVisible, onClose }, ref) => {
      ...
      >
        <BottomSheetView style={styles.container}>
          ...
          <View style={styles.actionsContainer}>
            {actions.map((action) => {
              const actionColor = action.destructive ? '#EF4444' : action.color || colors.text;
              ...
              return (
                ...
                >
                  <View style={styles.actionContent}>
                    ...
                    />
                    <Text style={[styles.actionText, { color: actionColor }]}>{action.title}</Text>
                  </View>
                </TouchableOpacity>
              );
            })}
