...
export const DeliveryTimePicker: React.FC<DeliveryTimePickerProps> = ({
  ...
  const handleClearTime = () => {
    ...
    Alert.alert('Timer Cleared', 'Delivery notifications have been cancelled', [
      { text: 'OK', onPress: onClose },
    ]);
  };
    ...
    <Modal visible={true} transparent animationType="slide">
      ...
      >
        ...
        >
          ...
          >
            Select estimated delivery time. You will receive notifications at 40%, 80%, and 100%
            completion.
          </Text>
          ...
          <View style={{ marginBottom: 20 }}>
            {commonDeliveryTimes.map((time) => (
              <TouchableOpacity
                ...
                style={{
                  backgroundColor:
                    currentMinutes === time.value ? colors.primary + '20' : colors.bg,
                  padding: 16,
                  borderRadius: 12,
                  marginBottom: 8,
                  borderWidth: 1,
